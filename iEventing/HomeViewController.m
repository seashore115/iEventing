...
@interface HomeViewController ()<MKMapViewDelegate,CLLocationManagerDelegate,UIAlertViewDelegate>
...
-(void)mapView:(MKMapView *)mapView annotationView:(MKAnnotationView *)view calloutAccessoryControlTapped:(UIControl *)control {
    ...
    [self performSegueWithIdentifier:@"DetailMain" sender:view];
    
}

-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if ([segue.identifier isEqualToString:@"DetailMain"]) {
        DetailViewController *detailMainViewController=segue.destinationViewController;
        detailMainViewController.longtitude=self.lastMapItemPinTapped.coordinate.longitude;
        detailMainViewController.latitude=self.lastMapItemPinTapped.coordinate.latitude;
    }
}
